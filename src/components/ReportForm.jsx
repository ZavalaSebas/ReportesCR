...
const ReportForm = ({ user, onReportCreated, selectedLocationForReport, onRequestLocationSelection, onFormDataChange }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
      <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">Crear Nuevo Reporte</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Opcional - se generará automáticamente si no se especifica</p>
        </div>
